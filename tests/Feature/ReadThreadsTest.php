...
class ReadThreadsTest extends TestCase
{
    ...
    public function a_user_can_filter_threads_according_to_a_channel()
    {
        ...
        $threadInChannel = create('App\Thread', ['channel_id' => $channel->id]);    //associate channeil_id with the channel we just create it
